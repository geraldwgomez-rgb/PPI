# Sistema monetario de contabilidad

<br>
Es una aplicacion que les sirve a empresas, negocios o personas a llevar un resumen diario del dinero y de su capital, siendo asi mas organiados. 
...
- React Router DOM 7 (`react-router-dom`) — manejo de rutas y navegación
- Supabase (`@supabase/supabase-js`) — autenticación, base de datos y backend
- Bootstrap 5.3 — estilos y componentes UI (navbar, cards, badges, etc.)
- Recharts 3 — gráficos de barras y de torta (dashboard de reportes)
- jsPDF + jsPDF-AutoTable — generación de reportes/tablas en PDF
...
- Llevar un resumen mensual de ingresos y gastos
- Conocer el presupuesto 
- Registrar gastos e ingresos de dinero
- Crear proyectos o "metas"
- Notificaciones  

# Autores
- Gerald Williams Gomez
- Yulian Monsalve Palacio
- Juan Jose Gaviria Aristizabal
- Daniel Gomez Ortiz
- Sarai Cardona Delgado